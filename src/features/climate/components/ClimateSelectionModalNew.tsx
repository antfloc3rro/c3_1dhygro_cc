...
import { ClimateData, ClimateType, ClimateApplication, SineCurveData, EPWData, WACData } from '../types';
        ...
        <div className="flex h-[calc(85vh-120px)]">
          ...
          <div className="flex-1 p-lg overflow-y-auto bg-greylight/5">
            ...
            {climateType === 'standard' && (
              <div className="flex items-center justify-center h-full">
                <div className="text-center text-greydark">
                  <p className="text-sm">Standard Conditions view coming soon</p>
                  <p className="text-xs mt-sm">ASHRAE 160, EN 15026, ISO 13788, WTA 6-2</p>
                </div>
              </div>
            )}
        ...
        <div className="text-sm text-greydark">
          {view === 'selection' && (
            <>
              ...
              {climateType === 'standard' && 'Select standard to continue'}
